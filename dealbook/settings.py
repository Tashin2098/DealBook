"""
Django settings for dealbook project.
...
SECRET_KEY = os.getenv("django-insecure-hi^p9@9a&l@%%qt9)z+m4jm&0#76i7jzntmpd@q0&ge8phx(jw'", 'change-this-in-production')
...
WSGI_APPLICATION = 'dealbook.wsgi.application'
...
AWS_SECRET_ACCESS_KEY = os.environ['AWS_SECRET_ACCESS_KEY']      # Reads from environment
AWS_STORAGE_BUCKET_NAME = os.environ['AWS_STORAGE_BUCKET_NAME']
AWS_S3_ENDPOINT_URL = os.environ.get('AWS_S3_ENDPOINT_URL', 'https://gateway.storjshare.io')
